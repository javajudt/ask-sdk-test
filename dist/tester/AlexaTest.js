...
class AlexaTest {
    ...
    mockDeviceAddressAPI(settings, currentItem) {
        ...
        if (currentItem.withDeviceAddress && (currentItem.withDeviceAddress.addressLine1 || currentItem.withDeviceAddress.addressLine2 ||
